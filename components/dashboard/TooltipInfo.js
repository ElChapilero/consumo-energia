...
export default function TooltipInfo({ numero }) {
  ...
  return (
    <div className="relative inline-block ml-2">
      {/* Icono Info con animación tipo botón */}
      <motion.div
      ...
      >
        <Info className="w-5 h-5 text-blue-400 transition-colors duration-200 hover:text-blue-300" />
      </motion.div>

      {/* MODAL unificado para móvil y PC */}
      <AnimatePresence>
        {open && (
          <motion.div
