...
export default function ChartLineAlertas({
  data = [],
  title = 'Tendencia',
  metrica = 'potencia',
}) {
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-center items-center gap-2 mb-4">
        <h3 className="text-xl font-semibold text-blue-300 tracking-wide">
          {tooltipInfo.text}
        </h3>
          ...
          >
            ...
            <Tooltip
              ...
              formatter={(value, name) =>
                name === 'promedio'
                  ? [`${Number(value).toFixed(2)} promedio`, 'Promedio']
                  : [`${Number(value).toFixed(2)} actual`, 'Actual']
              }
